...
export default async function Home() {
  ...
  return (
    <>
      <main className="min-h-screen max-h-screen ps-6 sm:ps-10 pt-10 sm:pt-14 flex flex-col">
        <div className="flex-none mb-6 sm:mb-12">
        ...
        <AppProvider initialData={initialData}>
          ...
          <div className="flex-1 flex flex-col sm:flex-row overflow-auto">
            ...
            <div className="sm:hidden flex-none mb-4">
              <div className="font-semibold opacity-40 mb-2.5">
                DELIVERY TIME
              </div>
            ...
            <div className="hidden sm:block flex-none w-60 min-h-max p-6 mr-5 card border-b-0 rounded-t-2.5">
              ...
              <div className="mb-6">
                <div className="font-semibold opacity-40 mb-4">
                  FOOD CATEGORY
                </div>
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
              ...
              <div className="flex flex-col overflow-hidden">
                <div className="flex-none display mb-5 sm:mb-8">
                  Restaurants
                </div>
